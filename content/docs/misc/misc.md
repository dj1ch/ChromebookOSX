...
**For anybody looking to get audio working, here are some bits of info you can use:**
...
>**Warning**: The hotkey to show boot drives does not work. Make a copy of your EFI with `ShowPicker` enabled if you need to boot from another drive in OpenCore.
